...
default
{
    state_entry()
    {
        ...
        line = 107;
outp += "\nGenerated by LSL2 Derived Files Generator. Database version: 0.0.20231219001; output module version: 0.0.20140625000";
c([
1,TRUE
,0,FALSE
,0x1,STATUS_PHYSICS
...
,0x800,CHANGED_MEDIA
,0x1000,CHANGED_RENDER_MATERIAL
,1,TYPE_INTEGER
]);
c([
2,TYPE_FLOAT
...
c([
1,PRIM_REFLECTION_PROBE_BOX
,2,PRIM_REFLECTION_PROBE_DYNAMIC
,0x1,DENSITY
,0x2,FRICTION
,0x4,RESTITUTION
...
c([
24,SKY_REFLECTION_PROBE_AMBIANCE
